...
such tools: \begin{tt}perf\end{tt}\cite{perfwiki}\cite{perfbg} and \begin{tt}lttng\end{tt}
...
All our code is available at https://\hspace{0pt}github.com/\hspace{0pt}dspeyer/\hspace{0pt}profiling
...
\bibitem{perfwiki}
  \emph{Perf wiki}
  https://\hspace{0pt}perf.wiki.kernel.org/\hspace{0pt}index.php/\hspace{0pt}Tutorial

\bibitem{perfbg}
  Brendan Gregg.
  \emph{perf Examples},
  http://www.brendangregg.com/\hspace{0pt}perf.html

\bibitem{lttng}
  Desnoyers and Dagenais.
  \emph{The LTTng tracer: A low impact performance and behavior monitor for
  GNU/\hspace{0pt}Linux},
   In Linux Symposium,
   2006
...
\bibitem{lttngLwn}
  ...
  2012,
  http://\hspace{0pt}lwn.net/\hspace{0pt}Articles/\hspace{0pt}491510/\hspace{0pt}
...
\bibitem{oncpu}
  ...
  \emph{On-CPU Flame Graphs},
   2014,
   http://\hspace{0pt}brendangregg.com/\hspace{0pt}FlameGraphs/\hspace{0pt}cpuflamegraphs.html 

\bibitem{offcpu}
  Brendan Gregg.
  \emph{Off-CPU Flame Graphs},
   2014,
   http://\hspace{0pt}brendangregg.com/\hspace{0pt}FlameGraphs/\hspace{0pt}offcpuflamegraphs.html

\bibitem{hotcold}
  Brendan Gregg.
  \emph{Hot/\hspace{0pt}Cold Flame Graphs},
   2014,
   http://\hspace{0pt}brendangregg.com/\hspace{0pt}FlameGraphs/\hspace{0pt}hotcoldflamegraphs.html

\bibitem{traceCompass}
  \emph{TraceCompass User Guide}
  http://\hspace{0pt}archive.eclipse.org/\hspace{0pt}tracecompass/\hspace{0pt}doc/\hspace{0pt}stable/\hspace{0pt}org.eclipse.tracecompass.doc.user/\hspace{0pt}User-Guide.html
...
\bibitem{lbr}
  ...
  2015,
  https://\hspace{0pt}lkml.org/\hspace{0pt}lkml/\hspace{0pt}2015/\hspace{0pt}4/\hspace{0pt}14/\hspace{0pt}232

\bibitem{Squirrelmail}
  \emph{Squirrelmail Documentation},
  http://\hspace{0pt}Squirrelmail.org/\hspace{0pt}documentation/\hspace{0pt}
...
\bibitem{pb}
  ...
  2008,
  http://\hspace{0pt}google-opensource.blogspot.com/\hspace{0pt}2008/\hspace{0pt}07/\hspace{0pt}protocol-buffers-googles-data.html
...
\bibitem{taoup}
  ...
  Addison Wesley,
  2003,
  http://\hspace{0pt}www.catb.org/\hspace{0pt}esr/\hspace{0pt}writings/\hspace{0pt}taoup/\hspace{0pt}html/\hspace{0pt}
